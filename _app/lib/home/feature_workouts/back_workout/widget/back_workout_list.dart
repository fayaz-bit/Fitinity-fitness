...
import '../../../../widget/dialogue/confirm_delete_dialogue.dart'; // ✅ import the dialog
      ...
      itemBuilder: (context, index) {
        ...
        return Padding(
          ...
          child: WorkoutCard(
            ...
            sets: workout['sets'] ?? '',
            reps: workout['reps'] ?? '',
            videoTitle: workout['videoTitle']?.isNotEmpty == true
                ? workout['videoTitle']
                : null,
            videoUrl: workout['videoUrl']?.isNotEmpty == true
                ? workout['videoUrl']
                : null,
            videoFilePath: workout['videoFilePath']?.isNotEmpty == true
                ? workout['videoFilePath']
                : null,
