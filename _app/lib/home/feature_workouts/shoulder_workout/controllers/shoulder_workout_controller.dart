...
import '../../../../database/featureworkouts_database/shoulder_database.dart';

class ShoulderWorkoutController {
  late ShoulderWorkoutDatabase db;

  Future<void> init(VoidCallback onReady) async {
    db = ShoulderWorkoutDatabase();
    await db.init();
    onReady();
  }
