...
class AdminGainCategoryController {
  late AdminAddedMealsWeightGainDatabase db;
  List<Map<String, String>> meals = [];

  Future<void> init(String categoryName, Function onReady) async {
    db = AdminAddedMealsWeightGainDatabase(categoryName);
    await db.initDB();
  ...
  Future<void> editMeal(
      BuildContext context, int index, Function onUpdate) async {
